...
import { StageTemplateProvider } from "@/providers/stageTemplateProvider";
import "./globals.css";
...
export const metadata: Metadata = {
  title: "RocketSales",
  description:
    "A CRM built for sales teams who want to leverage AI to close more deals.",
